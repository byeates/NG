package renderer
{
	...
	/*========================================================================================
	ANY COLLIDABLE STATIC OBJECT WILL INHERIT FROM THIS CLASS
		- Note: Entities that need collision will use a different version since those have
				properties setup already such as width, height, position
	========================================================================================*/
	public class r_collidable
	{
		...
		static protected const GROUP_COLLISION	:int = 2;
		...
		public function Destroy():void {
			globals.space.bodies.remove(m_body);
		}
		...
		protected function CreateBody():void {
			...
			m_body.shapes.at(0).filter.collisionGroup = GROUP_COLLISION;
