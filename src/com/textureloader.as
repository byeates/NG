package com
{
	...
	public class textureloader extends Loader
	{
		...
		public function textureloader( pvt:privateclass ) {
		...
		//singleton instance
		public static function get instance():textureloader { return _instance ? _instance : _instance = new textureloader( new privateclass() ); }
	}
}
